...
@$a="insert into mhsasia values  ('$id','$nama','$alamat','$nim','$email','$dusun','$rt','$rw','$no_telpon','$photo','$nik')";
...
<form class="form-inline" method="get">
  <div class="form-group">
    <select name="dusun" class="form-control" onchange="form.submit()">
      <option value="0">Filter dusun</option>
...
<form class="form-inline" method="get">
  <div class="form-group">
    <select name="filter" class="form-control" onchange="form.submit()">
      <option value="0">Filter RT</option>
      <?php $filter = (isset($_GET['filter']) ? strtolower($_GET['filter']) : NULL);  ?>
      <option value="001" <?php if($filter == '001'){ echo 'selected'; } ?>>001</option>
      <option value="002" <?php if($filter == '002'){ echo 'selected'; } ?>>002</option>
      <option value="003" <?php if($filter == '003'){ echo 'selected'; } ?>>003</option>
      <option value="004" <?php if($filter == '004'){ echo 'selected'; } ?>>004</option>
    </select>
  </div>
</form>
<!-- end filter -->
<table class="table table-striped table-hover">
  ...
  <?php
					if($dusun){
						$sql = mysqli_query($koneksi, "SELECT * FROM mhsasia WHERE  dusun='$dusun' ORDER BY nim ASC"); // query jika filter dipilih
					}elseif($filter){
						$sql = mysqli_query($koneksi, "SELECT * FROM mhsasia WHERE rt='$filter' ORDER BY nim ASC"); // query jika filter dipilih
					}else{
						$sql = mysqli_query($koneksi, "SELECT * FROM mhsasia ORDER BY nim ASC"); // jika tidak ada filter maka tampilkan semua entri
					}
...
<table width="100%" border="1" align="center" id="myTable">
  ...
  <tr class="header">
    ...
    <th width="80" scope="col">alamat</th>
...
<table width="100%" border="1">
  <tr>
    ...
    <th width="97"> <div align="center">nim </div></th>
...
?>
  <tr>
    ...
    <td><div align="center"><?php echo $result["nim"];?></div></td>
